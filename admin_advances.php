    ...
    <section class="content-grid coach-advances-content-grid">
        <article class="form-card">
            ...
            <form method="POST" class="attendance-form" autocomplete="off">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($adminAdvancesCsrfToken, ENT_QUOTES, 'UTF-8'); ?>">
                <input type="hidden" name="administrator_id" id="administrator_id" value="<?php echo htmlspecialchars($selectedAdministratorId, ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="professional-select" id="administratorSelect" data-placeholder="اختر الإداري من القائمة">
                            <button type="button" class="select-trigger" id="administratorSelectTrigger" aria-expanded="false">
                                <span class="select-trigger-text" id="administratorSelectText">
                                    <?php echo $selectedAdministratorMeta ? htmlspecialchars($selectedAdministratorMeta['full_name'], ENT_QUOTES, 'UTF-8') : 'اختر الإداري من القائمة'; ?>
                                </span>
                                ...
                                <div class="select-options" id="administratorOptionsList">
                                    <?php foreach ($administrators as $administrator): ?>
                                        ...
                                        >
                                            ...
                                            <span class="option-meta">📞 <?php echo htmlspecialchars($administrator['phone'], ENT_QUOTES, 'UTF-8'); ?></span>
                                        </button>
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <div class="selected-coach-meta" id="selectedAdministratorMeta">
                            <?php if ($selectedAdministratorMeta): ?>
                                <span>📞 <?php echo htmlspecialchars($selectedAdministratorMeta['phone'], ENT_QUOTES, 'UTF-8'); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="<?php echo htmlspecialchars(buildAdminAdvancesPageUrl(['date' => $selectedDate, 'edit' => $advanceRecord['id']]), ENT_QUOTES, 'UTF-8'); ?>" class="edit-btn">✏️ تعديل</a>
