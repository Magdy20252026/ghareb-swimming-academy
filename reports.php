...
<head>
    ...
    <title>الإحصائيات - <?php echo htmlspecialchars($academyName, ENT_QUOTES, 'UTF-8'); ?></title>
    ...
    <section class="period-toolbar">
        <div class="period-switcher">
            <?php foreach ($periodDefinitions as $periodKey => $periodDefinition): ?>
                <a
                    href="reports.php?period=<?php echo htmlspecialchars($periodKey, ENT_QUOTES, 'UTF-8'); ?>"
                    class="period-chip <?php echo $selectedPeriod === $periodKey ? 'active' : ''; ?>"
                >
                    <?php echo htmlspecialchars($periodDefinition['label'], ENT_QUOTES, 'UTF-8'); ?>
                </a>
            <?php endforeach; ?>
        </div>
        <div class="period-range"><?php echo htmlspecialchars(formatReportsPeriodRange($periodStartValue, $periodEndValue), ENT_QUOTES, 'UTF-8'); ?></div>
    </section>

    <section class="hero-grid">
        <article class="hero-card hero-card-main">
            <span>الإجمالي</span>
            <strong><?php echo htmlspecialchars(formatReportsMoney($netTotal), ENT_QUOTES, 'UTF-8'); ?> ج.م</strong>
        </article>
        <article class="hero-card">
            <span>الإيرادات</span>
            <strong><?php echo htmlspecialchars(formatReportsMoney($revenueTotal), ENT_QUOTES, 'UTF-8'); ?> ج.م</strong>
        </article>
        <article class="hero-card">
            <span>المصروفات</span>
            <strong><?php echo htmlspecialchars(formatReportsMoney($expenseTotal), ENT_QUOTES, 'UTF-8'); ?> ج.م</strong>
        </article>
        <article class="hero-card">
            <span>الفترة</span>
            <strong><?php echo htmlspecialchars($periodDefinitions[$selectedPeriod]['label'], ENT_QUOTES, 'UTF-8'); ?></strong>
        </article>
    </section>
                ...
                <article class="metric-card">
                    ...
                    <div class="metric-values">
                        ...
                        <div class="value-box value-box-money">
                            ...
                            <strong><?php echo htmlspecialchars(formatReportsMoney((float) $section['total']), ENT_QUOTES, 'UTF-8'); ?> ج.م</strong>
                        </div>
                    </div>
                        ...
                        <div class="money-breakdown-grid">
                            <?php foreach ($section['secondary_money_summaries'] as $summary): ?>
                                <div class="money-breakdown-box">
                                    ...
                                    <strong><?php echo htmlspecialchars(formatReportsMoney((float) $summary['total']), ENT_QUOTES, 'UTF-8'); ?> ج.م</strong>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
                        ...
                        <tr>
                            <?php foreach ($section['columns'] as $column): ?>
                                <td data-label="<?php echo htmlspecialchars($column['label'], ENT_QUOTES, 'UTF-8'); ?>">
                                    <?php echo htmlspecialchars(formatReportsCellValue($row, $column), ENT_QUOTES, 'UTF-8'); ?>
                                </td>
                            <?php endforeach; ?>
                        </tr>
                    <?php endforeach; ?>
